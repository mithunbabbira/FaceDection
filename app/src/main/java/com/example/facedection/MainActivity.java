//package com.example.facedection;
//
...
//                    Toast.makeText(MainActivity.this,"NO faces babbi",Toast.LENGTH_SHORT).show();
//
//                }else{
//
////                    Bundle bundle = new Bundle();
////                    bundle.putString(BabbiFaceDection.RESULT_TEXT, resultText);
////                    DialogFragment resultDialog = new ResultDialog();
////                    resultDialog.setArguments(bundle);
////                    resultDialog.setCancelable(false);
////                    resultDialog.show(getSupportFragmentManager(), BabbiFaceDection.RESULT_DIALOG);
//
//                    Bundle bundle = new Bundle();
//                    bundle.putString(BabbiFaceDection.RESULT_TEXT, resultText);
//                    DialogFragment resultDialog = new ResultDialog();
